...
let Value = create(function(value, unit){
  ...
  if (typeof value !== 'undefined') {
    this.tags.push('numeric');
    if (typeof unit === 'string') this.tags.push('unit');
    else this.tags.push('no-unit');
  }
  else if (typeof value === 'string') this.tags.push('keyword');
  else this.tags.push('unknown');
}, {
  ...
  equals: function(other){
    if (!(other instanceof Value)) other = new Value(...arguments);
    if (this.is('numeric') && other.is('numeric') &&
